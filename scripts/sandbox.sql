--- info
SELECT table_name From user_tables where upper(table_name) like '%EMP%';
SELECT table_name From user_tables where upper(table_name) like '%ARRI%';
SELECT table_name From user_tables where upper(table_name) like '%MOTO%';
SELECT table_name From user_tables where upper(table_name) like '%CLIENTE%';
SELECT table_name From user_tables where upper(table_name) like '%CIVIL%';
SELECT table_name From user_tables where upper(table_name) like '%FIDEL%';
SELECT table_name From user_tables where upper(table_name) like '%BONIF%';
SELECT table_name From user_tables where upper(table_name) like '%TIPO%';

describe empleado;
describe arriendo_moto;
describe motocicleta;
--- execution

declare
        cursor c_clientes is
                select numrun_cli, dvrun_cli, nombre_cli
                from cliente
        ...
        v_anno_processo constant number := 2025;
begin
        ...
        loop
                ...
                and extract(year from arriendo_moto.fecha_ini_arriendo) = v_anno_processo;
